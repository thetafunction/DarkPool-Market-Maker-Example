...
const (
	...
	// Invalid or malformed request parameters (missing fields, bad format, out of range).
	RejectReason_REJECT_REASON_INVALID_PARAMS RejectReason = 9
)
...
var (
	RejectReason_name = map[int32]string{
		...
		9: "REJECT_REASON_INVALID_PARAMS",
	}
...
type DepthSnapshot struct {
	...
	// Minimum fill size for token A (base token), as a wei string.
	// "0", empty, or omitted means no minimum.
	MinOrderSize  string `protobuf:"bytes,8,opt,name=min_order_size,json=minOrderSize,proto3" json:"min_order_size,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DepthSnapshot) GetMinOrderSize() string {
	if x != nil {
...
const file_mm_v1_mm_proto_rawDesc = "" +
	...
	"\x15heartbeat_interval_ms\x18\x03 \x01(\rR\x13heartbeatIntervalMs\"\xfe\x01\n" +
	...
	"\x04asks\x18\a \x03(\v2\x11.mm.v1.PriceLevelR\x04asks\x12$\n" +
	"\x0emin_order_size\x18\b \x01(\tR\fminOrderSize\":\n" +
	"\n" +
	"PriceLevel\x12\x14\n" +
	...
	"\x13QUOTE_STATUS_FAILED\x10\x02*\xf1\x02\n" +
	...
	"#REJECT_REASON_VERSION_NOT_SUPPORTED\x10\b\x12 \n" +
	"\x1cREJECT_REASON_INVALID_PARAMS\x10\t*\xbb\x02\n" +
	"\tErrorCode\x12\x1a\n" +
